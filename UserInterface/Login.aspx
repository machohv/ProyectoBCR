    ...
    <div class="login-page">
        <div class="form">
            ...
            <asp:TextBox ID="txtCedula" runat="server" placeholder="Cédula"></asp:TextBox>
                ...
                <asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="La cédula no corresponde a un empleado" ForeColor="Red" OnServerValidate="CedulaValidate" ControlToValidate="txtCedula" Display="Dynamic" ></asp:CustomValidator>
                <br />
